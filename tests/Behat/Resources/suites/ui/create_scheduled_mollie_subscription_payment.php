...
return (new Config())
    ->withProfile(
        (new Profile('default'))
        ->withSuite(
            (new Suite('ui_creating_scheduled_mollie_subscription_payment'))
            ...
            ->withFilter(new TagFilter('@create_scheduled_mollie_subscription_payment&&@ui')),
        ),
    )
;
